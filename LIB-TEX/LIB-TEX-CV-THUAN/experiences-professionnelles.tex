...
%\subsection{Recherche et Développement}
	...
	\cvlistitem{Environnements: Linux(Ubuntu, debian arm), C/C++, MPI, OpenMP, TAU, PAPI, PIN-Tool Intel, DynamoRIO, DynInst-API, Valgrind, gprof, git, eclipse, Make, Bash Shell, QtCreator, qemu}
	...
	\cvlistitem{Outils: Gestion de jobs (OAR, QSUB ), Make, TAU, Intel Vtune, Valgrind, gprof}
	...
	\cvlistitem{Environnements: Cluster Linux, MPI, OpenMP, C/C++, Shell, CVS, SVN, make, GnuPlot, valgrind, gprof}
...
% 	\cvlistitem{Environnements: Courbe Bézier, OpenGL, C/C++}
	...
	\cvlistitem{Environnements: Flash, ActionScript, Php, HTML}
